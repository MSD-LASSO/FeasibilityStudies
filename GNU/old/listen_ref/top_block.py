...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(int(samp_rate/channel_width), firdes.low_pass(
        	1, samp_rate, 15e3, 5e3, firdes.WIN_HAMMING, 6.76))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/pentoo/Documents/recording/weather_test_2', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15e3, 5e3, firdes.WIN_HAMMING, 6.76))
