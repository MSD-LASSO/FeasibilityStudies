...
GND = getStruct(Stations, GND_Error, Stations(1,:), GND_Error(1,:));
GND4= getStruct(Stations4, GND_Error4, Stations(1,:), GND_Error(1,:));
SAT = getStruct(Satellites, SAT_Error, Stations(1,:), GND_Error(1,:));
...
OneAtaTime3(GND,SAT,0,1,'SentinelSatECF_FullSensitivity',0);
