...
assert(logical(Output{1}(1)==(-(z - 1)*(z + 1))^(1/2)));
assert(logical(Output{1}(2)==0));
assert(logical(Output{1}(3)==-(-(z - 1)*(z + 1))^(1/2)));
assert(logical(Output{1}(4)==0));
assert(logical(Output{2}(1)==0));
assert(logical(Output{2}(2)==((z - 1)*(z + 1))^(1/2)));
assert(logical(Output{2}(3)==0));
assert(logical(Output{2}(4)==-((z - 1)*(z + 1))^(1/2)));
...
Output=Intersect(Surf,[x;y;z]);
figure()
fimplicit3(Surf,[-15 15 -15 15 -15 15])
hold on
fplot3(Output{1},Output{2},Output{3},'.','MarkerSize',10,'color','black');
axis square
