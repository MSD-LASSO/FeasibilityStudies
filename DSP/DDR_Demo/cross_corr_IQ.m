%DDR Demo
close all
[m, Fs] = audioread('Loc1_97900000Hz_IQ(Mission Control).wav');
...
for j = 1 : N
    ...
    if j > Rx2_sample_delay
        rx2(j, 1) = (1/sqrt(Rx2_Power_loss))*yt(j-Rx2_sample_delay, 1);
        rx2(j, 2) = (1/sqrt(Rx2_Power_loss))*yt(j-Rx2_sample_delay, 2);
    end
end
