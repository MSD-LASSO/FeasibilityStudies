...
% create input signal
[data, fs] = audioread('Loc1_101300000Hz_IQ_Test5.wav'); % sample requency and data
x = data(1:2000); % shorten data
clear data;
t_rep = 1/fs; % period of "continuous" input signal
t_low = 0;
t_high = t_rep*(length(x) - 1);
