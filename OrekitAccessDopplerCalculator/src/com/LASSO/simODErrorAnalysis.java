...
public class simODErrorAnalysis {
...
//                         home.getAbsolutePath());
 ...
 ///* Ground Station Triangle
  ...
  ///*
   ...
   //Propagation and using BooleanLogger to store all access times
   ...
   //Loop to determine max error for 'x' # of provided groundtracks (not necessary rn)
//for (double degreeError=6.3; degreeError<=6.3;degreeError=degreeError+1)   
//{

   
   // Loop to store az, el data from simulated ground track
	...
	for (int b=4;b<=4;b=b+4)   //loop to choose # of ground tracks. Right now, 'b=4;b<=4' means only 1 groun track is used.
	{
	  int entryIndex=b; //must be even. CHOOSING WHICH PASS TO LOOK AT
	   ...
	   kepler.propagate(stationOverlap.get(entryIndex+1).getState().getDate()); //entryIndex+1 is the exit time of satellite.
	   ...
	   int stationReference=0;    //stationReference=0 is STATION #1
	...
	// SIMULATED GAUSSIAN ERROR ADDITION IN 'rand_dub1, rand_dub2' variables  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	   	   double adjustedAzimuth=azimuth;//+rand_dub1;
	   	   double adjustedElevation=elevation;//+rand_dub2;
	       
	       azArray.add(adjustedAzimuth);    //adding az to array
	       elArray.add(adjustedElevation);  //adding el to array
...
//	   }
	    ...
	    // 'Casting (?)' the Orbit type to a KeplerianOrbit in order to get mean anomaly, right asc, and perigee.
	    ...
	    //  System.out.println(estimatedOrbit_init.getMeanA);
