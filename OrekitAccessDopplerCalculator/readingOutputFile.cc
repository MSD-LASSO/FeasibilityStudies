...
/* not needed anymore
 ...
 cout <<numStations<< '\n';
 getline (myfile,baseFreqLine);
 double baseFreq=stod(baseFreqLine.replace(0,14,""));
 cout <<baseFreq<< '\n';

 getline (myfile,signalBandwidthLine);
 double signalBandwidth=stod(signalBandwidthLine.replace(0,16,""));
 cout <<signalBandwidth<< '\n';

 getline (myfile,recordTimeLine);
 double recordTime=stod(recordTimeLine.replace(0,11,""));
 cout <<recordTime<< '\n';
*/
